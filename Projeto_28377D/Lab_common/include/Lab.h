...
#define ADC_SAMPLE_PERIOD   24300				            // 1999 = 50 kHz sampling w/ 100 MHz ePWM clock
#define PWM_HALF_PERIOD     19430           // period/2 for 2 kHz symmetric PWM w/ 100 MHz ePWM clock
#define PWM_DUTY_CYCLE      19430           // 25% duty cycle
#define PWM_DUTY_GANHO		 PWM_DUTY_CYCLE/3.3
...
// Data Types
//
// C2000 compiler v6.4.1 has a bug with the CLA compiler where _Bool is not
// defined.  Add _Bool definition to fix the issue until compiler is fixed.
