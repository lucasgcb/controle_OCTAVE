...
//--- Configure the clocks
	...
	SysCtrlRegs.PCLKCR3.bit.CLA1ENCLK = 1;		// SYSCLKOUT to CLA1 enabled
	...
	SysCtrlRegs.PCLKCR3.bit.COMP3ENCLK = 1;		// SYSCLKOUT to COMP3 enabled
	...
	SysCtrlRegs.PCLKCR2.bit.HRCAP4ENCLK = 1;	// SYSCLKOUT to HRCAP4 enabled
	SysCtrlRegs.PCLKCR2.bit.HRCAP3ENCLK = 1;	// SYSCLKOUT to HRCAP4 enabled
	SysCtrlRegs.PCLKCR2.bit.HRCAP2ENCLK = 1;	// SYSCLKOUT to HRCAP4 enabled
	SysCtrlRegs.PCLKCR2.bit.HRCAP1ENCLK = 1;	// SYSCLKOUT to HRCAP4 enabled
	...
	SysCtrlRegs.PCLKCR1.bit.EPWM7ENCLK = 1;		// SYSCLKOUT to ePWM7 enabled
